...
public class Maps
{
    ...
    public static void main( String[] args )
    {
        ...
        System.out.println(map.computeIfPresent( 3, ( num, val ) -> num + val ));
        System.out.println( map.get( 3 ) ); // 3val3
        
        map.computeIfPresent( 11, ( num, val ) -> num + val );
        System.out.println(map.computeIfPresent( 11, ( num, val ) -> num + val ));
        System.out.println("este" +  map.get( 11 ) ); // 3val3
